...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        # INPUT PATH
        dataset_dir='/media/amrgaballah/Backup_Plus/DCASE2021_SELD_dataset/',  # Base folder containing the foa_dev/mic_dev and metadata folders

        # OUTPUT PATH
        feat_label_dir='/media/amrgaballah/Backup_Plus/DCASE2021_SELD_dataset/seld_feat_label_mod_mel_foa_new/',  # Directory to dump extracted features and labels
        ...
        label_sequence_length=100,   # Feature sequence length
    ...
    print('feature_label_resolution',feature_label_resolution)
