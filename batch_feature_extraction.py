...
if 'dev' in process_str:
    ...
    dev_feat_cls.extract_all_feature_mel()
    dev_feat_cls.preprocess_features_mel()
    dev_feat_cls.extract_all_feature_mod()
    dev_feat_cls.preprocess_features_mod()
    dev_feat_cls.concatinate_features_mel_mod()
    
    # # Extract labels in regression mode
    dev_feat_cls.extract_all_labels()
    print('labels regression',dev_feat_cls.extract_all_labels())
