...
pred = os.path.join(params['dcase_output_dir'], '4_foa_dev_test/fold6_room1_mix001.csv')
...
ref_dir = os.path.join(params['dataset_dir'], 'metadata_dev', 'dev-test')
...
print('path', os.path.join(aud_dir, ref_filename))
audio, fs = feat_cls._load_audio(os.path.join(aud_dir, 'dev-test',ref_filename))
